...
var prompts = [
    ...
    },
    {
        ...
        prompt_values: [
            ...
            {
                value: 'Fackin keep the yap trapped',
                class: 'btn-default btn-disagree',
                weight: 0
            }
        ]
    },
    {
        ...
        prompt_values: [
            ...
            {
                value: 'Fack Ya, unless we married',
                class: 'btn-default btn-disagree',
                weight: 0
            }
        ]
    },
    {
        ...
        prompt_values: [
            ...
            {
                value: 'Fack You, my friends choose ME',
                class: 'btn-default btn-disagree',
                weight: 0
            }
        ]
    ...
    */
    ...
    function createValueButtons() {
        for (var li_index = 0; li_index < prompts.length; li_index++) {
            ...
            for (var i = 0; i < prompts[li_index].prompt_values.length; i++) {
                var btn_group = document.createElement('div');
                btn_group.className = 'btn-group';
    
                var button = document.createElement('button');
                var button_text = document.createTextNode(prompts[li_index].prompt_values[i].value);
                button.className = 'group' + li_index + ' value-btn btn ' + prompts[li_index].prompt_values[i].class;
                button.setAttribute('index', li_index);
    ...
    $('.value-btn').mousedown(function () {
        ...
        if($(this).hasClass('active')) {
            ...
            total -= (findPromptWeight(prompts, this_group) * findValueWeight(prompts[this_index].prompt_values, $(this).text()));
        } else {
            // $('[class='thisgroup).prop('checked', false);
            total -= (findPromptWeight(prompts, this_group) * findValueWeight(prompts[this_index].prompt_values, $('.'+this_group+'.active').text()));
    ...
    $('#submit-btn').click(function () {
        ...
        if(total <= 3) {
            ...
            document.getElementById('results').innerHTML = '<b>You are a Beginner!</b><br><br>\
    ...
    Introverted people are known for thinking things through before they speak, enjoying small, close groups of friends and one-on-one time, needing time alone to recharge, and being upset by unexpected changes or last-minute surprises. Introverts are not necessarily shy and may not even avoid social situations, but they will definitely need some time alone or just with close friends or family after spending time in a big crowd.\
            ...
            document.getElementById('results').innerHTML = '<b>You are an Advanced Beginner!</b><br><br>\
    ...
    When I am among people, I make eye contact, smile, maybe chat if there’s an opportunity (like being stuck in a long grocery store line). As an extrovert, that’s a small ‘ping’ of energy, a little positive moment in the day.';
            ...
            document.getElementById('results').innerHTML = '<b>You are Intermediate!</b><br><br>\
            On the opposite side of the coin, people who are extroverted are energized by people. They usually enjoy spending time with others, as this is how they recharge from time spent alone focusing or working hard.\
    <br><br>\
    I like how this extrovert explains the way he/she gains energy from being around other people:\
    <br><br>\
    When I am among people, I make eye contact, smile, maybe chat if there’s an opportunity (like being stuck in a long grocery store line). As an extrovert, that’s a small ‘ping’ of energy, a little positive moment in the day.';
            ...
            document.getElementById('results').innerHTML = '<b>You are Expert!</b><br><br>\
